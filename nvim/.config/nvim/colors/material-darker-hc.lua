...
vim.cmd 'highlight PmenuSbar guibg=#1a1a1a guifg=#383838'
...
vim.cmd 'highlight NormalFloat guibg=#1a1a1a guifg=#848484' -- floating windows
...
vim.cmd 'highlight Conceal guifg=#545454'
...
vim.cmd 'highlight FzfLuaBorder guibg=#1a1a1a guifg=#848484'
vim.cmd 'highlight FzfLuaPreviewNormal guibg=#1a1a1a guifg=#848484'
...
vim.cmd 'highlight SnacksDashboardHeader guifg=#eeffff'
